...
namespace WASA_EMS.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ResetVoltageRange()
        {
            string query1from = "";
            string query1to = "";

            query1from = "update tblResourceRangeSelector set MinRange = 0 where ParameterID = 115 ";
            query1to = "update tblResourceRangeSelector set MaxRange = 0 where ParameterID = 115 ";
            ...
            return RedirectToAction("VoltageRange");
        }
        public ActionResult VoltageRange()
        {
            string query1from = "select MinRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = 1068";
            string query1to = "select MaxRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = 1068";
            string time1from = "";
            string time1to = "";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
        ...
        [HttpPost]
        public ActionResult VoltageRange(FormCollection review)
        {
            ...
            {
                query1from = "update tblResourceRangeSelector set MinRange = " + Convert.ToDouble(time1from) + " where ParameterID = 115";
                query1to = "update tblResourceRangeSelector set MaxRange = " + Convert.ToDouble(time1to) + " where ParameterID = 115 ";
            ...
            {
                query1from = "update tblResourceRangeSelector set MinRange = " + Convert.ToDouble(time1from) + " where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
                query1to = "update tblResourceRangeSelector set MaxRange = " + Convert.ToDouble(time1to) + " where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
                using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
                {
                    try
                    {
            ...
            query1from = "select MinRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
            query1to = "select MaxRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
        ...
        public ActionResult VoltageRangeIndexChanged(string value)
        {
            ...
            string query1from = "select MinRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + value + "')";
            string query1to = "select MaxRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + value + "')";
            string time1from = "";
            string time1to = "";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
        ...
        [HttpPost]
        public ActionResult ResetCurrentRange()
        {
            string query1from = "";
            string query1to = "";

            query1from = "update tblResourceRangeSelector set MinRange = 0  where ParameterID = 118 ";
            query1to = "update tblResourceRangeSelector set MaxRange = 0  where ParameterID = 118 ";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
            ...
            return RedirectToAction("CurrentRange");
        }
        public ActionResult CurrentRange()
        {
            string query1from = "select MinRange from tblResourceRangeSelector where ParameterID = 118 and ResourceID = 1068";
        ...
        [HttpPost]
        public ActionResult CurrentRange(FormCollection review)
        {
            string resource = review["resource"].ToString();
            string time1from = review["time1from"].ToString();
            string time1to = review["time1to"].ToString();
            ...
            if (resource == "Update for All Locations")
            {
                query1from = "update tblResourceRangeSelector set MinRange = " + Convert.ToDouble(time1from) + " where ParameterID = 118";
                query1to = "update tblResourceRangeSelector set MaxRange = " + Convert.ToDouble(time1to) + " where ParameterID = 118 ";
            ...
            {
                query1from = "update tblResourceRangeSelector set MinRange = " + Convert.ToDouble(time1from) + " where ParameterID = 118 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
                query1to = "update tblResourceRangeSelector set MaxRange = " + Convert.ToDouble(time1to) + " where ParameterID = 118 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
                using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
                {
                    try
                    {
            ...
            query1from = "select MinRange from tblResourceRangeSelector where ParameterID = 118 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
            query1to = "select MaxRange from tblResourceRangeSelector where ParameterID = 118 and ResourceID = (select ResourceID from tblResource where ResourceLocation = '" + resource + "')";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
        ...
        public string GetData()
        {
                        ...
                        while (sdr.Read())
                        {
                            ...
                            using (SqlDataReader sdr1 = cmd1.ExecuteReader())
                            {
                                while (sdr1.Read())
                                {
                                    ...
                                    {
                                        valuee = Math.Round((Convert.ToDouble(sdr1["ParameterValue"]) / 101.94), 2).ToString();
                                    }
                                    else if (sdr1["ParameterName"].ToString() == "vib_x")
                                    {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            markers += "]";
            markers = JsonConvert.SerializeObject(markers);
            return markers;
        }
        ...
        public PartialViewResult _Welcome()
        {
            ...
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                ...
                {
                    recycle1 += Convert.ToInt32(cR1p1);
                ...
                {
                    recycle1 += Convert.ToInt32(cR1p2);
                ...
                {
                    recycle1 += Convert.ToInt32(cR1p3);
                ...
                {
                    recycle2 += Convert.ToInt32(cR2p1);
                ...
                {
                    recycle2 += Convert.ToInt32(cR2p2);
                ...
                {
                    recycle2 += Convert.ToInt32(cR2p3);
                ...
                totalRunningRecycle = recycle1 + recycle2;
        ...
        {
            DateTime nowtime = DateTime.Now.AddHours(0);
