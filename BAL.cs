...
namespace WASA_EMS
{
    public class BAL
    {
        ...
        public int shutDownPump(string sender, string v12, string v23, string v13, string i1, string i2, string i3)
        {
            int returnCode = 0;
        ...
        public string voltageError(string id, string v12, string v23, string v13, string mode)
        {
            string result = "";
            double mod = Convert.ToDouble(mode);
            if (mod == 0)
            {
                mode = "Scheduling";
            }
            ...
            string addNotification = "insert into tblNotifications (ResourceID, ParameterID, ParameterValue, notificationTime, Comment) ";
            addNotification += " values (";
            addNotification += " (select ResourceID from tblResource where MobileNumber = '" + id + "'),118,0, CONVERT(CHAR(24), CONVERT(DATETIME, '" + TimeZoneInfo.ConvertTimeBySystemTimeZoneId(DateTime.UtcNow, "Pakistan Standard Time").ToString() + "', 103), 121) , 'Over/Under Voltage Error Detected in "+mode+" Mode (V12 : " + v12 + ", V13 : " + v13 + ", V23 : " + v23 + ") at \"'+(select ResourceLocation from tblResource where MobileNumber = '" + id + "')+'\" ' ";
            addNotification += " )";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
        ...
        public string currentError(string id, string i1, string i2, string i3)
        {
            ...
            string addNotification = "insert into tblNotifications (ResourceID, ParameterID, ParameterValue, notificationTime, Comment) ";
            addNotification += " values (";
            addNotification += " (select ResourceID from tblResource where MobileNumber = '" + id + "'),118,0, CONVERT(CHAR(24), CONVERT(DATETIME, '" + TimeZoneInfo.ConvertTimeBySystemTimeZoneId(DateTime.UtcNow, "Pakistan Standard Time").ToString() + "', 103), 121) , 'Over/Under Current Error Detected  (I1 : " + i1 + ", I2 : " + i2 + ", I3 : " + i3 + ") at \"'+(select ResourceLocation from tblResource where MobileNumber = '" + id + "')+'\" ' ";
            addNotification += " )";
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
        ...
        public string ChangeTubewellWorkingMode(string id, string v12, string v23, string v13, string i1, string i2, string i3)
        {
            ...
            using (SqlConnection conn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand(query2, conn);
                    cmd.ExecuteNonQuery();
                    result = "Mode Change Successful";
                }
                catch (Exception ex)
                {
                    result = "Mode Change Unsuccessful";
                }
            }
            return result;
        }
        ...
        public string getCurrentRange(string sender)
        {
            DataTable dt = new DataTable();
            string jsonObj = "";
            string query = "select MinRange, MaxRange from tblResourceRangeSelector where ParameterID = 118 and ResourceID = (select ResourceID from tblResource where MobileNumber = '" + sender + "')";
            using (SqlConnection conn1 = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
        ...
        public string getVoltageRange(string sender)
        {
            DataTable dt = new DataTable();
            string jsonObj = "";
            string query = "select MinRange, MaxRange from tblResourceRangeSelector where ParameterID = 115 and ResourceID = (select ResourceID from tblResource where MobileNumber = '" + sender + "')";
            using (SqlConnection conn1 = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                try
                {
